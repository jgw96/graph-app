  ...
  render() {
    return html`
      ...
      (this.installed === false &&
        ...
        this.caughtEvent)
        ? html`
            <sl-button id="install-button" @click="${() => this.install()}"
              >Install Mail GO</sl-button
            >
          `
        : null}
      ${this.openInstallModal
        ? html`<div id="install-info">
            <sl-menu>
              ...
              >
              <sl-menu-item @click="${() => this.browserInstall()}"
                >Install from your Browser</sl-menu-item
              >
              <sl-divider></sl-divider>
              <sl-menu-item @click="${() => this.cancel()}"
                >Cancel</sl-menu-item
              >
            </sl-menu>
          </div>`
